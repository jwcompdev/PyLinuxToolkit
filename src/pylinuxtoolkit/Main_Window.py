...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabViewMain.setTabText(self.tabViewMain.indexOf(self.tabGeneralInfo), _translate("MainWindow", "General Info"))
        self.btnSubmit.setText(_translate("MainWindow", "Submit"))
        self.tabViewMain.setTabText(self.tabViewMain.indexOf(self.tabTerminal), _translate("MainWindow", "Terminal"))
